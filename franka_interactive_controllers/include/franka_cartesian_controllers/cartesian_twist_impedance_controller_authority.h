...
class CartesianTwistImpedanceControllerAuthority : public controller_interface::MultiInterfaceController<
 ...
 private:
  ...
  double K_trans, D_trans, K_rot, D_rot;
  double K_R_trans  = 800.0;//1500.0;
  double K_H_trans  = 1.0;
  double K_R_rot    = 0.03;//50.0;//50.0;
  double K_H_rot    = 0.03;
  ...
  ros::Subscriber sub_alpha_h_;
  void alphaHCallback(const std_msgs::Float64::ConstPtr& msg);
