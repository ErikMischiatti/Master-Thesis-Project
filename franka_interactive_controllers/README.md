...
###########################################################################
for simulation of controller: roslaunch franka_interactive_controllers simulate_pana_gazebo.launch headless:=false controller:=cartesian_pose_impedance_controller
for testing of controller on real robot: roslaunch franka_interactive_controllers franka_interactive_bringup.launch controller:=cartesian_pose_impedance_controller # cartesian pose impedance controller
                                         # joint gravity compensation controller
                                         roslaunch franka_interactive_controllers franka_interactive_bringup.launch robot_ip:=franka
                                         roslaunch franka_interactive_controllers joint_gravity_compensation_controller.launch
for recording demos:  1. roslaunch franka_interactive_controllers franka_interactive_bringup.launch
                      2. roslaunch franka_interactive_controllers joint_gravity_compensation_controller.launch
                      3. roslaunch franka_interactive_controllers franka_kinesthetic_teaching.launch
###########################################################################
...
```
$ git clone ssh://git@gitlab.tuwien.ac.at:822/johannes.heidersberger/franka_interactive_controllers.git
```
