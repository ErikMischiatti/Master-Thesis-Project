...
from NIST_BT.myBehaviors.put_in_clip import create_PutInClip_branch
...
root_seq = py_trees.composites.Sequence("CLip_seq", True)


from sensor_msgs.msg import JointState
root_seq.add_children([
    create_pick_branch(),
    create_PutInClip_branch(),
    create_CloseClip_branch(),
