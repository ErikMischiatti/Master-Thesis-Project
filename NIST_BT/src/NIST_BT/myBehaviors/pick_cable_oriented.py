...
goal_look.slowdown_factor = 2.5

goal_look.goal.position.x = 0.5
goal_look.goal.position.y = 0.0
goal_look.goal.position.z = 0.45
goal_look.goal.orientation.x = 0.99
goal_look.goal.orientation.y = 0
goal_look.goal.orientation.z = 0
goal_look.goal.orientation.w = 0.01


goal_look.dhb_file = "/home/asl_team/catkin_ws/src/record_franka_ros/scripts/ours_look_2.1.npz"

def create_pick_branch_oriented():
    ...
    pour_branch_seq.add_children([
        ...
        get_cable_pose,
        CreateMoveGoal("Create pick goal", "cable_pose", "cable_pose_goal", "/home/asl_team/catkin_ws/src/record_franka_ros/scripts/ours_pick.npz", 2, -0.02), 
