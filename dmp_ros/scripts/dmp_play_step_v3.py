...
class DMP_ROS:
    ...
    def __init__(self):
        ...
        self.sub_F_ext_base = rospy.Subscriber("/ft_sensor/ft_compensated_base", WrenchStamped, self.wrench_sensor_cb, queue_size=10)
    ...
    def wrench_sensor_cb(self, msg: WrenchStamped):
    ...
    for current_segment in range(n_segments):
        ...
        if current_segment == search_segment and version == 1:
            ...
            while t < dmp_duration:
                ...
                if d.wrench_sensor[2] > 10 and version == 2 and searched == False:
                    ...
                    # Rearrange to [x, y, z, qx, qy, qz, qw]
                    start_pose = [start_pose[0], start_pose[1], start_pose[2], start_pose[4], start_pose[5], start_pose[6], start_pose[3]]
                    # spiral_segment = get_search_trajectory(start_pose=start_pose, end_pose=None, spiral_separation=0.02, )
                    spiral_segment = get_search_trajectory(start_pose=start_pose, spiral_size=0.1, spiral_separation=0.005)
                    ...
                    for i, pose in enumerate(pose_traj):
                        ...
                        # Break the inner loop if force threshold is met
                        if d.wrench_sensor[2] <= z_force_threshold and i > pose_traj.shape[0]*0.01:
                            searched = True
                            break
